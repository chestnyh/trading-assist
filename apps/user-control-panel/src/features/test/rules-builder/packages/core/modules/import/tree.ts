...
export const getTree = (immutableTree: any, light = true, children1AsArray = true) => {
...
export const loadTree = (serTree: any) => {
...
export const isImmutableTree = (tree: any) => {
  return Map.isMap(tree);
};

export const isTree = (tree: any) => {
