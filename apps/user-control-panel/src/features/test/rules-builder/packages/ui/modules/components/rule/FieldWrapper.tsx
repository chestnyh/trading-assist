...
interface FieldWrapperProps {
  classname?: string;
  canSelectFieldSource?: boolean;
  config: any;
  selectedField?: any;
  selectedFieldSrc?: any;
...
export default class FieldWrapper extends Component<FieldWrapperProps> {
  meta: any;
  ValueSources: any;
  ...
  onPropsChanged(nextProps: FieldWrapperProps) {
    ...
    if (configChanged) {
      ...
      this.ValueSources = (pr: any) => renderValueSources(pr, config.ctx);
    }
  }
  ...
  getMeta({
    ...
    const fieldSourcesOptions = fieldSources.map((srcKey: any) => [
      srcKey,
      {
