// @ts-ignore - chroma-js doesn't have type declarations
import {default as chroma} from "chroma-js";

export const setColorOpacity = (color: any, alpha: any) => chroma(color).alpha(alpha).hex();

export const generateCssVarsForLevels = (
  isDark: any, cssVar: any, baseColor: any, baseDarkColor: any = undefined
) => {
  const maxLevel = 20;
