...
export default function AuthNavbar(props: any) {
  ...
  routes.map((route: any) => {
    if (route.items) {
      authObject = route.items.find((link: any) => link.name === "Authentication");
    }
  });
          ...
          <MenuList
            ...
            <Stack direction='row' spacing='24px'>
              ...
              <SimpleGrid templateColumns='1fr' width='100%'>
                {createAuthLinks((authObject as any).items || [])}
              </SimpleGrid>
            </Stack>
          </MenuList>
        </Menu>
        ...
        <Menu isOpen={isOpenApplication}>
          <MenuList
            ...
            <Grid templateColumns='1fr' gap='16px'>
              {createApplicationLinks((applicationsObject as any).items || [])}
            </Grid>
          </MenuList>
        </Menu>
      </Stack>
        ...
        <Menu isOpen={isOpenEcommerce}>
          <MenuList
            ...
            <Grid templateColumns='repeat(2, 1fr)' gap='16px'>
              {createEcommerceLinks((ecommerceObject as any).items || [])}
            </Grid>
          </MenuList>
        </Menu>
      </Stack>
