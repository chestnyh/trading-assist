...
export type SignUpAction =
  | {
      ...
      payload: { field: keyof SignUpStep1FormData; value: unknown };
    }
  | {
      type: 'SET_FIELD_STEP2';
      payload: { field: keyof SignUpStep2FormData; value: unknown };
    }
  | {
      type: 'SET_FIELD_STEP3';
      payload: { field: keyof SignUpStep3FormData; value: unknown };
    }
...
export type SignUpContextValue = {
  ...
  step1: {
    ...
    setField: (
      field: keyof SignUpStep1FormData,
      value: SignUpStep1FormData[keyof SignUpStep1FormData]
    ) => void;
  ...
  step2: {
    ...
    setField: (
      field: keyof SignUpStep2FormData,
      value: SignUpStep2FormData[keyof SignUpStep2FormData]
    ) => void;
  ...
  step3: {
    ...
    setField: (
      field: keyof SignUpStep3FormData,
      value: SignUpStep3FormData[keyof SignUpStep3FormData]
    ) => void;
