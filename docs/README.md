...
1) **Info Collector**. This module continuously gathers market data from various cryptocurrency exchanges. It aggregates real-time information, such as price fluctuations, trading volume, and other relevant metrics, and standardizes it for further analysis. The Info Collector is designed to be highly scalable, capable of integrating with multiple exchanges simultaneously to provide a comprehensive view of the crypto market.
