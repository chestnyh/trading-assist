...
import type { ServiceCommTransport } from '../transport/transport';
import type { RmqTransportOptions } from '../rmq/rmq-transport';

export type ServiceCommModuleOptions =
  | {
      transport: ServiceCommTransport;
    }
  | {
      rmq: RmqTransportOptions;
    };
